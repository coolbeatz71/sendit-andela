let btnSignIn = document.getElementById('btn-sign-in-admin');

// Event on user signIn
btnSignIn.addEventListener('click', (e) => {
  e.preventDefault();
  const email = document.getElementById('emailSignInAdmin').value.trim();
  const password = document.getElementById('passwordSignInAdmin').value.trim();
